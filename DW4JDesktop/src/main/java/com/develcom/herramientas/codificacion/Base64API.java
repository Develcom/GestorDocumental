...
public class Base64API {
    ...
    public final static void main(String[] args) {
        if (args.length < 3) {
            ...
            //  encode
                case "-e":
                    Base64API.encodeFileToFile(infile, outfile);
                    break;
            //  decode
                case "-d":
                    Base64API.decodeFileToFile(infile, outfile);
                    break;
                default:
    ...
    public static String encodeObject(java.io.Serializable serializableObject, int options) {
        ...
        try {
            ...
            b64os = new Base64API.OutputStream(baos, ENCODE | options);
    ...
    public static String encodeBytes(byte[] source, int off, int len, int options) {
        ...
        if (gzip == GZIP) {
            java.io.ByteArrayOutputStream baos = null;
            java.util.zip.GZIPOutputStream gzos = null;
            Base64API.OutputStream b64os = null;
    ...
    public static boolean encodeToFile(byte[] dataToEncode, String filename) {
        ...
        Base64API.OutputStream bos = null;
        try {
            bos = new Base64API.OutputStream(
                    new java.io.FileOutputStream(filename), Base64API.ENCODE);
    ...
    public static boolean decodeToFile(String dataToDecode, String filename) {
        ...
        try {
            bos = new Base64API.OutputStream(
                    new java.io.FileOutputStream(filename), Base64API.DECODE);
    ...
    public static byte[] decodeFromFile(String filename) {
        ...
        Base64API.InputStream bis = null;
        try {
            ...
            // Open a stream
            bis = new Base64API.InputStream(
                    new java.io.BufferedInputStream(
                            new java.io.FileInputStream(file)), Base64API.DECODE);
    ...
    public static String encodeFromFile(String filename) {
        ...
        try {
            ...
            bis = new Base64API.InputStream(
                    new java.io.BufferedInputStream(
                            new java.io.FileInputStream(file)), Base64API.ENCODE);
            ...
            // Save in a variable to return
            encodedData = new String(buffer, 0, length, Base64API.PREFERRED_ENCODING);
                ...
                // Else decoding
                    ...
                    //  also padded correctly
                        ...
                        default:
                            ...
                            throw new java.io.IOException("Improperly padded Base64 input."); // end 
                    }
        ...
        public void write(int theByte) throws java.io.IOException {
            ...
            // Else, Decoding
                ...
                if (decodabet[theByte & 0x7f] > WHITE_SPACE_ENC) {
                    ...
                    {
                        int len = Base64API.decode4to3(buffer, 0, b4, 0, options);
                        out.write(b4, 0, len);
